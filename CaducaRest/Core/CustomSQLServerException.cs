...
namespace CaducaRest.Core
{
	...
	{
		public string MuestraErrorSqlServer(SqlException sqlServerError,
										string tablaActual,
										string claseOrigen)
		{
			try
			{
				...
				string mensajeDetalle = "Intente nuevamente si continua el error " +
						...
						+ "(" + sqlServerError.Message.ToString() + ") en "
				...
				switch (sqlServerError.Number)
				{
					...
					case 1451:
						...
						break;
					case 1452:
						string[] cadenas = sqlServerError.Message
					...
					case 1062:
						...
						string[] erroers = sqlServerError.Message
														.Split(Convert.ToChar("'"));
